@php
    ...
    $formElements = [
        ...
        [
            'type' => 'normal',
            'label' => Form::label('name', 'Description', $labeltAttr),
            'element' => Form::text('description', $item['description'], $elementAttr)
        ],
        [
            'type' => 'normal',
        ...
        [
            'type' => 'normal',
            'label' => Form::label('name', 'Link', $labeltAttr),
            'element' => Form::text('link', $item['link'], $elementAttr)
        ],
        [
            'type' => 'thumb',
